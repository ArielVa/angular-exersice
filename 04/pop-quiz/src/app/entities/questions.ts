export const QUESTIONS_DB = [
  ...
  {
    "caption": "In media entertainment '1984' originally refers to a X?",
    "answers": [
      "Book",
      "Movie",
      "Play",
  ...
  {
    "caption": "The eight planet of the Milky Way solar system is?",
    "answers": [
      "Venus",
      "Jupiter",
      "Pluto",
  ...
  {
    "caption": "The Tower of Babel was first referenced in which book?",
    "answers": [
      "The Bible",
      "The New Testement",
      "The Quran",
  ...
  {
    "caption": "What date is referenced in the 1971 song September by 'Earth, Wind & Fire'?",
    "answers": [
      "26th of September",
      "23rd of September",
      "24th of September",
